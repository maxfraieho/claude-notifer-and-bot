...
async def handle_text_message(
    ...
    try:
        ...
        ) if localization_manager else "🤔 Processing your request..."
        ...
        if not claude_integration:
            ...
            ) if localization_manager else "❌ Claude integration not available"
        ...
        for i, message in enumerate(formatted_messages):
            try:
                ...
                ) if localization_manager else "❌ Failed to send response. Please try again."
                await update.message.reply_text(
            ...
            try:
                ...
                if conversation_enhancer.should_show_suggestions(claude_response):
                    ...
                    if suggestions:
                        ...
                        ) if localization_manager else "💡 **What would you like to do next?**"
                        await update.message.reply_text(
                            suggestions_text,
                            parse_mode=None,
        ...
        ) if localization_manager else f"❌ **Error processing message**\n\n{str(e)}"
